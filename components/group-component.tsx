...
const GroupComponent: NextPage<GroupComponentType> = ({ className = "", data, setData }) => {
  ...
  return (
    <header
    className={`ml-[20px] w-[1440px] bg-ghostwhite flex flex-col items-start justify-start pt-[15.5px] px-0 pb-[0.4px] box-border gap-[30.5px] max-w-[110%] shrink-0 text-left text-sm text-white font-questrial mq750:gap-[15px] ${className}`}
  >
        ...
        <div className="flex-1 flex flex-row items-start justify-between max-w-full gap-5 mq1225:flex-wrap">
          <div className="w-[795.5px] flex flex-col items-start justify-start pt-[1.3px] px-0 pb-0 box-border max-w-full">
            <div className="self-stretch flex flex-col items-start justify-start max-w-full">
              ...
              <div className="relative font-semibold z-[1] text-black">
                Call Us: 1-877-794-9511
              </div>

                <a className="[text-decoration:none] relative font-semibold text-[inherit] inline-block min-w-[55px] z-[1] text-black">
                  Email Us
                </a>
              </div>
              <div className="ml-[200px] self-stretch flex flex-row items-start justify-start gap-[49.3px] max-w-full mt-[20.7px] mq750:flex-wrap mq450:gap-[25px]">
          ...
          <nav className="m-0 h-[17px] w-[301px] relative text-left text-sm text-white font-questrial">
            <a className="[text-decoration:none] absolute top-[0px] left-[0px] font-semibold text-[inherit] inline-block min-w-[54px] z-[1] text-black">
              Services
            </a>
            <a className="[text-decoration:none] absolute top-[0px] left-[86px] font-semibold text-[inherit] inline-block min-w-[62px] z-[1] text-black">
              Attorneys
            </a>
            <a className="[text-decoration:none] absolute top-[0px] left-[180px] font-semibold text-[inherit] inline-block min-w-[53px] z-[1] text-black">
              Support
            </a>
            <a className="[text-decoration:none] absolute top-[0px] left-[265px] font-semibold text-[inherit] inline-block min-w-[36px] z-[1] text-black">
              Login
            </a>
          </nav>
        </div>
